...
with(powerc2007, plot(dateandtime, Voltage, type = "l", ylab = "Voltage", xlab ="datetime"))
with(powerc2007, {
...
with(powerc2007, plot(dateandtime, Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab ="datetime"))
